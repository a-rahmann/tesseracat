...
export class Planner {
  ...
  constructor(model?: AgentModel) {
    this.model = model || new OllamaGemmaModel('gemma3:4b');
  }
   ...
   */
  public async plan(goal: AgentGoal, context: PlannerContext): Promise<AgentPlan> {
...
Output strictly valid JSON array of recovery PlanStep objects.`;
   ...
   */
  private createFallbackPlan(goal: AgentGoal, context: PlannerContext): PlanStep[] {
