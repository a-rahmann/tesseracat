...
export class DOMAgent {
   ...
   */
  public static getLoginWatcherScript(rememberedUsername: string | null = null): string {
    return `
      (() => {
   ...
   */
  public static getAutofillAddressScript(profile: UserAddressProfile): string {
    return `
      (() => {
   ...
   */
  public static getDMInspectionScript(): string {
    return `
      (() => {
   ...
   */
  public static getDMSendReplyScript(replyText: string): string {
    return `
      (() => {
   ...
   */
  public static getCoBrowsingObservationScript(): string {
    return `
      (() => {
