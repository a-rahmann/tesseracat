...
export class VoiceManager {
  ...
  public async finishCommandRecording(): Promise<void> {
    ...
    if (this.currentState !== 'COMMAND_LISTENING' && this.currentState !== 'WAKE_DETECTED') return;
    ...
    try {
      ...
      const grammarRes = VoiceGrammarCorrector.getInstance().correct(commandToProcess);
