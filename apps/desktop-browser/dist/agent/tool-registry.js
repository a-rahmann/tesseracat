...
const index_js_1 = require("../services/connectors/index.js");
const youtube_tools_js_1 = require("../services/connectors/youtube-tools.js");
class ToolRegistry {
    ...
    registerDefaultTools() {
        ...
        (0, index_js_1.initializeConnectors)();
        const connectorRegistry = index_js_1.ConnectorRegistry.getInstance();
        // Gmail tools
        this.registerTool({
            name: 'gmail.search',
            category: 'READ',
        ...
        this.registerTool({
            ...
            execute: async (args) => youtube_tools_js_1.YouTubeTools.play(args),
        });
    }
}
