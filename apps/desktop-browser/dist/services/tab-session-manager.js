...
exports.TabSessionManager = void 0;
class TabSessionManager {
     ...
     */
    getOrCreateSession(tabId, url = 'about:blank', title = 'New Tab') {
     ...
     */
    recordUserPrompt(tabId, text, intent) {
     ...
     */
    recordAssistantResponse(tabId, text, resultSummary, targetUrl) {
        const session = this.getOrCreateSession(tabId);
        const turn = {
            id: `turn-${Date.now()}-${Math.random().toString(36).substring(2, 6)}`,
            role: 'assistant',
...
exports.TabSessionManager = TabSessionManager;
//# sourceMappingURL=tab-session-manager.js.map